      ...
      <form class="register">
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Username..." class="validate">
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Password..." class="validate">
          </div>
          <div class="form-group col-md-6">
            <label for="formGroupExampleInput2">Confirm Password</label>
            <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Confirm Password..." class="validate">
          </div>
        </div>
        <div class="row">
